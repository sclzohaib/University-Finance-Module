...
public class GRNDTO {
    ...
    public GRNDTO(Long id, Long grnNo, Date date, Date purchaseDate, String status, Long recievedQuantity, Long totalQuantity, String reasonForRejection, String recievedBy, String postedBy, String inspectedBy, String departmentHead) {
        this.id = id;
        GrnNo = grnNo;
        this.date = date;
